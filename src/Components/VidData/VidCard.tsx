                ...
                {vid !== null && vid.items.length > 0 ?
                    <>
                        <>
                            ...
                            <div className={`${screen < 700 ? `max-w-[calc(100vw/3)] p-1`: 'max-w-2xl py-2 pr-2 pl-4'}`}> 
                                <Link to={`/watch/${vidId}`}>
                                    <h1 className='font-normal text-lg line-clamp-2 overflow-hidden pb-1'>{vid.items[0].snippet.title}</h1>
