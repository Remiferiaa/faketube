...
/*
'https://www.googleapis.com/youtube/v3/[videos]?part=snippet,contentDetails&chart=mostPopular&maxResults=[24]&fields=items(id,snippet)&key=[apikey]' //homepage videos
